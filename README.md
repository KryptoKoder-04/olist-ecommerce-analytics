...
>
> **Designed for:** Data Analyst and Business Analyst portfolio.
...
### Best Resume Bullets for This Project

> **Built an end-to-end e-commerce analytics platform on 96K+ orders using SQL, Python, Excel, and Power BI to analyze revenue, category performance, state-wise sales, delivery SLA issues, customer retention patterns, and repeat-purchase risk.**

> **Designed executive dashboards and business insight reports identifying revenue concentration, low-margin categories, regional sales gaps, delivery delays, and customer retention opportunities with actionable recommendations.**

> **Performed RFM customer segmentation and lifetime value (CLV) analysis on 93K+ customers, identifying repeat-purchase patterns and targeting at-risk customers for retention campaigns.**

---

## 📌 What NOT to Claim

- ❌ "98.74% churn rate" — Use "97.6% single-purchase customers" instead
- ❌ "18% profit leakage" — Say "Estimated profit (assumed 20% cost ratio)" instead
- ❌ "Advanced ML model" — The churn prediction is optional; focus on analytics instead
- ❌ "Scalable production system" — This is a portfolio project, not production code
...
**Built for portfolio & interview readiness.**
